...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32735',
            extent: [700949.663935, 9718217.352100, 710382.915029, 9727885.507431],
            units: 'm'})
    })
});
...
layerSwitcher.showPanel();
    ...
    var searchLayer = new ol.SearchLayer({
      layer: lyr_Limiteadministrative_1,
      colName: 'NOM',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([697194.273266, 9717455.505089, 711119.564116, 9729272.839068], map.getSize());
